...
- (void)useBlueStyle
{
	self.normalGradientColors = [NSArray arrayWithObjects:
						  (id)[ [UIColor colorWithRed:64.0/255.0 
								 green:133.0/255.0
								 blue: 245.0/255.0
								 alpha:1.0] CGColor],
						  (id)[ [ UIColor colorWithRed:26.0/255.0 
								 green:80.0/255.0
								 blue: 220.0/255.0
								 alpha:1.0] CGColor],
						  nil
	...
	self.highlightGradientColors = [NSArray arrayWithObjects:
						  (id)[ [UIColor colorWithRed:125/255.0 
								 green: 136.0/255.0
								 blue: 165.0/255.0
								 alpha:1.0] CGColor],
						  (id)[ [ UIColor colorWithRed: 39.0/255.0 
								 green: 63.0/255.0
								 blue:  109.0/255.0
								 alpha:1.0] CGColor],
						  nil
    ...
    self.highlightGradientColors = [NSMutableArray arrayWithObjects:
                                    [NSNumber numberWithFloat:1.0f],
                                    [NSNumber numberWithFloat:0.0f],
                                    nil];
